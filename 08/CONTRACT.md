...
- `public.s08_items`: id, board_id, name, sku, quantity(integer 0..1000000), unit, low_stock(integer 0..1000000), revision(integer), updated_at, updated_by. 보드 내 SKU 대소문자 무시 중복 금지.
